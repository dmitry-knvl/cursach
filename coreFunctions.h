/*****************************************************************
@file
@brief Заголовочный файл основных функций
Здесь описываются функции, используемые непосредственно в точке 
входа (main)
*****************************************************************/
#pragma once
...
@param mode тип префикса перед ней
@param br следует ли переносить строку перед выводом записи
*****************************************************************/
...
@return структуру, хранящую в себе путь до файла, его имя и
расширение
*****************************************************************/
...
@param A отсортированный массив (вектор)
@param OutputFile поток файла результата
*****************************************************************/
...
статистику слов по алфавиту
@param txt текст из исходного файла
@param n количество слов в массиве
@param t время сортировки
@param a отсортированный массив (вектор)
@param OutputFile поток файла статистики
*****************************************************************/
...
@param A указатель на сортируемый массив
*****************************************************************/
...
@param a указатель на сортируемый массив (вектор)
@param f указатель на функцию обратного вызова (сортировщик)
